...
/>
Whether starting fresh or continuing with an existing project, navigate to the "Projects" section. Choose to create a new project or open an existing one.

Set the dimensions, selecting from vertical, horizontal, or square, ensuring a perfect fit for your vision.
...
/>
Express your vision for the Web UI by typing in your prompt. For additional inspiration, click on "Discover" button!
